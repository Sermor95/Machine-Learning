...
class FeatureSelection:     
    ...
    def __init__(self, dataset, criba, top_feat, threshold):
    ...
    def procesa(self):
        ...
        best_features_pearson_s = feature_selection('pearson',X_train, y_train,top_feat,threshold)
        best_features_pearson_c = feature_selection('pearson',X_train_new, y_train,top_feat,threshold)
        ...
        best_features_mutual_s = feature_selection('mutual_information', X_train, y_train, top_feat, threshold)
        best_features_mutual_c = feature_selection('mutual_information', X_train_new, y_train, top_feat, threshold)
        results.append(
        ...
        best_features_forward_s = feature_selection('forward',X_train, y_train,top_feat,None)
        best_features_forward_c = feature_selection('forward',X_train_new,y_train,top_feat,None)
        ...
        best_features_backward_s = feature_selection('backward', X_train, y_train, top_feat,None)
        best_features_backward_c = feature_selection('backward', X_train_new, y_train, top_feat,None)
        ...
        best_features_forward_float_s = feature_selection('forward_floating', X_train, y_train, top_feat,None)
        best_features_forward_float_c = feature_selection('forward_floating', X_train_new, y_train, top_feat,None)
        ...
        best_features_forward_float_s = feature_selection('backward_floating', X_train, y_train, top_feat,None)
        best_features_forward_float_c = feature_selection('backward_floating', X_train_new, y_train, top_feat,None)
        ...
        # HYBRID: RFE
        best_features_rfe_s = feature_selection('RFE', X_train, y_train, top_feat, threshold)
        best_features_rfe_c = feature_selection('RFE', X_train_new, y_train, top_feat, threshold)
        results.append(
